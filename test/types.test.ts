...
function getTwoSlashQueries() {
  ...
  {
    "text": "(property) initial: \"Error: no states defined\""
  },
  {
    "text": "(property) 1: \"Error: Only string identifiers allowed\""
  },
  {
    "text": "(property) X: \"Error: An event payload should be an object, eg `t<{ foo: number }>()`\""
  },
  {
    "text": "(property) X: \"Error: An event payload cannot have a property `type` as it's already defined. In this case as 'X'\""
  },
  {
    "text": "(property) 1: \"Error: only string types allowed\""
  },
  {
    "text": "(property) 1: \"Error: only string types allowed\""
  },
  {
    "text": "(property) $$exhaustive: \"Error: '$$exhaustive' is a reversed name\""
  },
  {
    "text": "(property) $$exhaustive: \"Error: '$$exhaustive' is a reversed name\""
  },
  {
    "text": "(property) Z: \"Error: Event type 'Z' is not found in schema.events which is marked as\""
  },
  {
    "text": "(property) Z: \"Error: Event type 'Z' is not found in schema.events which is marked as\""
  },
  {
    "text": "(property) initial: \"Oops you have met a TypeScript limitation, please add `on: {}` to state nodes that only have an `effect` property. See the documentation to learn more.\""
  },
  {
    "completions": [
      "a",
