...
export namespace R {
  export type Of<K extends string, V> = { __V: V; __K: K };

  export type Unknown = { __V: unknown; __K: string };

  export type Key<R extends R.Unknown> = R extends { __K: infer K } ? K : never;
  export type Value<R extends R.Unknown> = R extends { __V: infer V } ? V : never;
